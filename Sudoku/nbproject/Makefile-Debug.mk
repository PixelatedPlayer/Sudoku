...
${OBJECTDIR}/src/Engine/Engine.o: src/Engine/Engine.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Engine/Engine.o src/Engine/Engine.cpp

${OBJECTDIR}/src/Engine/Log.o: src/Engine/Log.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Engine
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Engine/Log.o src/Engine/Log.cpp

${OBJECTDIR}/src/Game/Controller.o: src/Game/Controller.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Game
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Game/Controller.o src/Game/Controller.cpp

${OBJECTDIR}/src/Game/Sudoku.o: src/Game/Sudoku.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Game
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Game/Sudoku.o src/Game/Sudoku.cpp

${OBJECTDIR}/src/Game/View.o: src/Game/View.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Game
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Game/View.o src/Game/View.cpp

${OBJECTDIR}/src/Graphics/Frame.o: src/Graphics/Frame.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Graphics
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Graphics/Frame.o src/Graphics/Frame.cpp
